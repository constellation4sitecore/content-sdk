...
```bash
npm install @constellation4sitecore-content-sdk/labels --save
```
...
```json
  "modules": [
    ....
    "npm:@constellation4sitecore-content-sdk/labels"
  ],
```
...
```tsx
import { LabelService } from '@constellation4sitecore-content-sdk/labels';
